...
def _errors(est_value, act_value):
...
if __name__ == '__main__':
    ...
    act_f0_test, act_f2_test = get_actual_values(ACC_LOG_RES_TEST)

    # compute estimates
    est_0th_fm(fme, ACC_LOG_SRC, act_f0)
    # est_2nd_fm(fme, ACC_LOG_SRC, act_f2)

    # est_0th_fm(fme, ACC_LOG_SRC_TEST, act_f0_test)
    # est_2nd_fm(fme, ACC_LOG_SRC_TEST, act_f2_test)
