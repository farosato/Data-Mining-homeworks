...
\begin{itemize}
	...
	\begin{align*}
		\Pr(A) = \Pr(A_{13} \cup A_{23} \cup A_{33}) = \Pr(A_{13}) + \Pr(A_{23}) + \Pr(A_{33})
	\end{align*}
	
	since the events $A_{13}, A_{23}$ and $A_{33}$ are disjoint each other. Using (\ref{aij}), we can easily compute the single probabilities and conclude that
	\begin{align*}
		\Pr(A) \simeq 0.217
	\end{align*}
	...
	since there are:
	\begin{itemize}
		\item $13 \cdot 12$ different combination of ranks.
...
\begin{center}
	\includegraphics[]{images/deck.jpg}
\end{center}
